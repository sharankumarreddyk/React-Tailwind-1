        ...
        <div className="max-w-screen-xl md:h-20 lg:h-28 flex flex-wrap items-center justify-end p-4">
          ...
          <div className="flex justify-center items-center md:hidden">
            ...
            <button
              onClick={handleNav}
              type="button"
              className="inline-flex items-center p-2 w-10 h-10 justify-center font-extrabold text-white rounded-lg focus:outline-none ring-white focus:ring-2"
              aria-expanded={nav}
            >
              {nav ? (
        ...
        <div className="absolute md:top-24 top-16 right-10 bg-white p-0.5 rounded-lg  w-80 ">
          <div className="relative ">
            <input
              type="text"
              placeholder="Search..."
              className="w-full p-2 pr-10 border rounded-lg focus:outline-none focus:border-[#0F1C40]"
            />
            <button
              onClick={handleSearch}
