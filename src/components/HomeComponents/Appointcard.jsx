        ...
        <div className="w-fit shadow-md rounded-t-lg rounded-b-md border-2 border-[#0F1C40] scale-[82%] sm:scale-100">
                        <div className="bg-[#0F1C40] text-white p-2 rounded-t-md ">
                            <div className="flex justify-between">
                                <div>
                                    ...
                                    <p className="lg:text-3xl text-xl font-bold">{Product}</p>
                                </div>
                        ...
                        <div className="p-2 bg-white rounded-b-lg">
                            ...
                            <div className="flex justify-between  pt-2 ">
                                        ...
                                        <div className="text-[#0F1C40] rounded-full flex items-center space-x-2 p-2">
                                        ...
                                        <div className='p-2'>
                                            <button
                                            className="bg-white border-2 h-10 border-blue-950 text-[#0F1C40] rounded-lg px-4 py-1 text-sm font-bold hover:bg-gray-100">
                                            Details
                                            </button>
                                        </div>
