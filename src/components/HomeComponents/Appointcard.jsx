...
function Appointcard({ Product, Name }) {
  return (
    <div className="w-full shadow-md rounded-t-xl space-y-1 rounded-b-lg border-2 border-[#0F1C40] ">
      ...
      <div className="p-4 bg-white rounded-b-lg">
        ...
        <div className="flex justify-between items-center pt-2 flex-wrap sm:flex-nowrap">
  ...
  <div className="text-[#0F1C40] bg-white rounded-full flex items-center space-x-2 sm:p-2">
    {/* Location Icon */}
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
