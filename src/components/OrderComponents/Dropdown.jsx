  ...
  return (
    <div className="relative inline-block text-left w-full sm:w-auto z-50">
      <button
        ...
        className="flex justify-between items-center p-1 md:px-2 rounded-md border-[1px] border-blue-950 text-sm font-thin text-[#0F1C40] hover:bg-gray-50 focus:outline-none overflow-hidden w-full sm:w-auto"
      >
