...
const ServiceBox = ({ title, temperature, param6, param7, unitRange, isDamaged }) => (
  <div className={`absolute bg-white border ${isDamaged ? 'border-red-500' : 'border-green-500'} rounded-md p-2 shadow-lg opacity-0 transition-opacity duration-300 w-42 group-hover:opacity-100`}>
    <div className={`${isDamaged ? 'text-red-500' : 'text-blue-950'} font-bold text-md`}>{title}</div>
    <p className="text-sm">Temperature: <span className="font-bold text-lg">{temperature}</span></p>
    {param6 && (
      <p className="text-sm">Param 6:<br /> <span className="font-bold text-lg">{param6}</span></p>
    )}
    {param7 && (
      <p className="text-sm">Param 7:<br /> <span className="font-bold text-lg">{param7}</span></p>
    )}
    ...
    <>
      <div className='p-4'>
        ...
        <div className="grid  md:grid-cols-10">
          ...
          <div className="slide relative col-span-5 md:mt-5">
            <img src={i2} alt="Image 1" className="w-fit h-auto" />

            {/* Service Box and Pointer Group */}
            <div className="absolute top-40 left-80 group">
            ...
            <div className="absolute top-60 left-52 group">
              <div className="bg-green-600 text-white rounded-full w-5 px-1 justify-center">
                X
              </div>
              <ServiceBox
            ...
            <div className="absolute bottom-48 left-32 group">
              <div className="bg-green-600 text-white rounded-full w-5 px-1 justify-center">
                X
              </div>
              <ServiceBox
            ...
            <div className="absolute top-16 right-2/4 group">
              <div className="bg-green-600 text-white rounded-full w-5 px-1 justify-center">
                X
              </div>
              <ServiceBox
            ...
            {/* Damaged Part */}
            <div className="absolute top-60 right-60 group">
