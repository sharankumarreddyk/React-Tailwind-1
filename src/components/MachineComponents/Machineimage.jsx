...
const ServiceBox = ({ title, temperature, param6, param7, unitRange, isDamaged, onClose }) => (
  <div
...
const MachineImage = ({ selectedMachineIndex }) => {
  ...
  const dynamicPositions = {
    ...
    part2: { top: '35%', left: '50%' },
    part3: { top: '45%', left: '65%' },
    part4: { top: '45%', left: '10%' },
    part5: { top: '12%', left: '35%' },
  };

  const fixedPositions = {
    part1: { top: '15%', left: '30%' },
    part2: { top: '25%', left: '30%' },
                ...
                >
                  ...
                  {visibleServiceBox === part && (
                    <ServiceBox
                      ...
                      onClose={() => toggleServiceBox(part)} // Close on cancel button click
                    />
                  )}
                </div> 
              )
  ...
  {visibleServiceBox === "part1" && (
    <div className="absolute mt-5 z-20 bg-white border border-red-500 text-red-500 rounded-md p-2 shadow-lg">
      ...
      <div className="flex justify-between mt-3 text-red-500  font-bold text-md">
        Part 1 <p>Damage</p>
      </div>
      <div className="flex">
        <p className="text-sm">
